...
Pod::Spec.new do |s|
  ...
  s.version  = '1.0.0'
  s.license  = 'MIT'
  s.summary  = 'A calendar component that emulates the native iOS monthly calendar component'
  s.homepage = 'https://github.com/klazuka/Kal'
  s.author   = { 'Michael Forrest' => 'michael.forrest@gmail.com' }

  # Specify the location from where the source should be retreived.
  #
  s.source   = { :git => 'https://github.com/klazuka/Kal.git', :branch => 'master' }
  # s.source   = { :svn => 'http://EXAMPLE/Kal/tags/1.0.0' }
  # s.source   = { :hg  => 'http://EXAMPLE/Kal', :revision => '1.0.0' }

  s.description = 'An optional longer description of Kal.'
